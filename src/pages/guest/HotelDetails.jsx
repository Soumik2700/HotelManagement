            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Premium Amenities</h3>
                        <p className="text-gray-600">{hotel.amenities?.length || 5}+ facilities available</p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">24/7 Service</h3>
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg p-8 text-white text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-6 py-3 rounded-lg transition-colors duration-300">
                            Call Now: +91 1234567890
                        </button>
                        <button className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-semibold px-6 py-3 rounded-lg transition-colors duration-300">
                            Live Chat Support
                        </button>
                    </div>
                </div>
